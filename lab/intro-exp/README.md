...
Задание учит ставить эксперимент над ОС корректно: фиксировать окружение,
...
Понимание возможностей и ограничений таких подходов важно при разработке
системных и прикладных приложений.
...
В приложениях записи представлены вершинами графа, а обращения
к ним — обходом связей между вершинами. Вершины имеют фиксированное полжение в
файле и могут быть ближе/дальше от своих соседей.

Итоговая метрика в каждой из конфигурации — **одно число**
