...
Для выданных приложений данные (записи) представлены в виде вершин графа, а
доступ к ним — обходом связей между вершинами. Вершины имеют фиксированное
полжение в файле и могут быть ближе/дальше от своих соседей.
