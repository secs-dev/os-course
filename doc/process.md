...
- Repository name: `os-course` / `xv6-riscv`.
...
1. Призовите преподавателя практики на ревью. (<ins>один</ins> тэг в сообщении PR: `@somebody`)
...
1. Напишите [отчет](report.md) в соответствии с требованиями в "Приложении Б".
...
Подробные правила составления отчета приведены в [report.md](report.md).
